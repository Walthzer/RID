["WFAR", "Spawn IED",
{
	...
	[_position,_iedType, "standard", "INT", 3] call FUNC(createIED);
...
["WFAR", "Create Pressure Plate",
{
	...
	[_objectUnderCursor, _thresholdMass] call FUNC(createPressurePlate);
}] call Ares_fnc_RegisterCustomModule;
...
["WFAR", "Create Vibration Detector",
{
	...
	[_objectUnderCursor] call FUNC(createVibrationDetector);
}] call Ares_fnc_RegisterCustomModule;
