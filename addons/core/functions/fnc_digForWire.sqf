 ...
 *
 * Example:
 * [_this#0] call rid_core_fnc_digForWire;
 *
 * Public: [No]
*/
params["_player"];
...
[6, [_player, (animationState _player)], _fnc_digCompleted, {[_this#0#0, _this#0#1, 1] call ace_common_fnc_doAnimation}, "Diggy Diggy"] call ace_common_fnc_progressBar;
