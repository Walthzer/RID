...
def main():
    ...
    print("""
  ######################################
  # RID Development Environment Setup #
  ######################################

  This script will create your RID dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your RID project folder:
    [Arma 3 installation directory]\\{} => RID project folder
    P:\\{}                              => RID project folder
